...
h = plot(0:0.05:1, A_C_total , 'b', 0:0.05:1, A_M_total, 'c', 0:0.05:1, A_N_total, 'r', 0:0.05:1, C_total , 'b*', 0:0.05:1, M_total, 'c^', 0:0.05:1, N_total, 'rx', [a,a],[8,26], 'k:',  [b,b],[8,26],'k:',  [a1,a1],[8,26], 'm:',  [b1,b1],[8,26],'m:');
h1 = legend('Spec', 'YiNing', 'New');
xlabel(' Paging ratio (N_{pg} = 100, N_{rd} = 100, m_p = 54, p = 0.25)');  
ylabel(' Total number of success UE');   
...
print(figure1, '-depsc', 'P_prob_total_25.eps');