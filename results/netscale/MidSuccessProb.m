function [average_success_prob_rd, average_success_prob_pg, total_success] = MidSuccessProb(Npg, Nrd, mp ,p)
    ...
    for i = 1:test_round
        ...
        for i = Npg + 1:N,
            if (UE_state(i) == 0)
                UE_preamble(i) = unidrnd(mp - round(Npg*Paging_ratio)) + round(Npg*Paging_ratio);
