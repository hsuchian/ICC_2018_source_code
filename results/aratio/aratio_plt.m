...
%set( h , 'linewidth' , 1.2 );
hl = legend('LTE random', 'LTE page', 'C-Free random','C-Free page', 'C-avoid random', 'C-avoid page');
legend boxoff;
set(gca, 'YTick',[0:.1:.5]);
ylim([0,0.42]);
set(gca, 'XTick',[0:.2:1]);
...
print(figure1, '-depsc', 'aratio_prob.eps');
hold off;
...
pos = get(hl, 'position');
loci = get(gca, 'position');
set(hl, 'position', [loci(1)-0.01 pos(2)+0.35 pos(3) pos(4)]);

print(figure1, '-depsc', 'aratio_UE.eps');